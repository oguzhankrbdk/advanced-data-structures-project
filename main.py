...
def test_unsuccessful_insertion_attempt_comparison(dataset):
...
def test_execution_time_comparison(dataset):
...
""" test_unsuccessful_insertion_attempt_comparison(dataset)
test_execution_time_comparison(dataset) """
#test_quadratic_probing(dataset)
test_double_hashing(dataset)